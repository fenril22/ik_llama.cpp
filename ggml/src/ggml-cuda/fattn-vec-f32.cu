...
void ggml_cuda_flash_attn_ext_vec_f32(ggml_backend_cuda_context & ctx, ggml_tensor * dst) {
    ...
    FATTN_VEC_F32_CASE(256, GGML_TYPE_PLANAR3_0, GGML_TYPE_PLANAR3_0)
    FATTN_VEC_F32_CASE(256, GGML_TYPE_ISO3_0,    GGML_TYPE_ISO3_0)
    FATTN_VEC_F32_CASE(256, GGML_TYPE_PLANAR4_0, GGML_TYPE_PLANAR4_0)
    FATTN_VEC_F32_CASE(256, GGML_TYPE_ISO4_0,    GGML_TYPE_ISO4_0)
