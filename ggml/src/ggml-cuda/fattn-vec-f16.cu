...
void ggml_cuda_flash_attn_ext_vec_f16(ggml_backend_cuda_context & ctx, ggml_tensor * dst) {
    ...
    FATTN_VEC_F16_CASE(128, GGML_TYPE_TURBO3C_0, GGML_TYPE_TURBO3C_0)
    FATTN_VEC_F16_CASE(128, GGML_TYPE_TURBO3_0,  GGML_TYPE_Q8_0)
    FATTN_VEC_F16_CASE(128, GGML_TYPE_Q8_0,      GGML_TYPE_TURBO3_0)
    FATTN_VEC_F16_CASE(128, GGML_TYPE_TURBO3C_0, GGML_TYPE_Q8_0)
    FATTN_VEC_F16_CASE(128, GGML_TYPE_Q8_0,      GGML_TYPE_TURBO3C_0)
    ...
    FATTN_VEC_F16_CASE(256, GGML_TYPE_TURBO3C_0, GGML_TYPE_TURBO3C_0)
    ...
    if (K->ne[0] == 128) {
        if (K->type == V->type) {
            return K->type == GGML_TYPE_Q4_0 || K->type == GGML_TYPE_Q8_0 || K->type == GGML_TYPE_F16 || K->type == GGML_TYPE_IQ4_NL ||
                   ...
                   K->type == GGML_TYPE_PLANAR4_0 || K->type == GGML_TYPE_ISO4_0 ||
                   K->type == GGML_TYPE_TURBO3_0  || K->type == GGML_TYPE_TURBO4_0 ||
                   K->type == GGML_TYPE_TURBO2_0  || K->type == GGML_TYPE_TURBO3C_0;
        }
        if ((K->type == GGML_TYPE_TURBO3_0  && V->type == GGML_TYPE_Q8_0) ||
            (K->type == GGML_TYPE_Q8_0      && V->type == GGML_TYPE_TURBO3_0)) return true;
        if ((K->type == GGML_TYPE_TURBO3C_0 && V->type == GGML_TYPE_Q8_0) ||
            (K->type == GGML_TYPE_Q8_0      && V->type == GGML_TYPE_TURBO3C_0)) return true;
        return (K->type == GGML_TYPE_Q8_0 && V->type == GGML_TYPE_IQ4_NL) ||
               (K->type == GGML_TYPE_Q6_0 && V->type == GGML_TYPE_Q5_0)   ||
               (K->type == GGML_TYPE_Q8_0 && V->type == GGML_TYPE_Q6_0)   ||
               (K->type == GGML_TYPE_Q8_0 && V->type == GGML_TYPE_IQ4_NL);
    ...
    if (K->ne[0] == 256) {
        if (K->type == V->type &&
            (K->type == GGML_TYPE_PLANAR3_0 || K->type == GGML_TYPE_ISO3_0 ||
             K->type == GGML_TYPE_PLANAR4_0 || K->type == GGML_TYPE_ISO4_0 ||
             K->type == GGML_TYPE_TURBO3_0  || K->type == GGML_TYPE_TURBO4_0 ||
             K->type == GGML_TYPE_TURBO2_0  || K->type == GGML_TYPE_TURBO3C_0)) return true;
        return K->type == GGML_TYPE_F16 || K->type == GGML_TYPE_Q8_0;
    }
    return false;
#endif
